...
class TestImageToBase64(unittest.TestCase):
    ...
    def test_png_encoding(self):
        ...
        result = convert_img.image_to_base64(
            img, "png"
        )
...
class TestCreateTracedSVG(unittest.TestCase):
    ...
    def test_create_traced_svg_success(
        ...
        mock_img_open.return_value.__enter__.return_value = (
            mock_img
        )
    ...
    @patch("subprocess.run")
    def test_create_traced_svg_no_potrace(
        self, mock_run
    ):
...
class TestGetFileSizeInfo(unittest.TestCase):
    ...
    @patch("builtins.print")
    def test_file_size_smaller_output(
        self, mock_print
    ):
...
class TestBugs(unittest.TestCase):
    ...
    @patch("tempfile.NamedTemporaryFile")
    @patch("PIL.Image.open")
    def test_create_traced_svg_format_bug(
        self, mock_img_open, mock_tempfile
    ):
