...
class TestIntegrationWithRealImage(
    ...
    def setUp(self):
        ...
        self.assertTrue(
            self.test_image.exists(),
            "Test image klaus-desktop.jpeg not found",
        )
    ...
    def test_embed_method_png(self):
        ...
        output_path = (
            self.temp_dir / "test_output_png.svg"
        )
    ...
    def test_embed_method_jpeg(self):
        ...
        output_path = (
            self.temp_dir / "test_output_jpeg.svg"
        )
    ...
    def test_embed_method_webp(self):
        ...
        output_path = (
            self.temp_dir / "test_output_webp.svg"
        )
    ...
    def test_max_size(self):
        ...
        output_path = (
            self.temp_dir / "test_max_size.svg"
        )
    ...
    def test_background_color(self):
        ...
        output_path = (
            self.temp_dir / "test_background.svg"
        )
    ...
    def test_overwrite_warning(self):
        ...
        output_path = (
            self.temp_dir / "test_overwrite.svg"
        )
        ...
        with patch(
            ...
            with patch(
                ...
                warning_found = any(
                    "already exists" in call
                    for call in calls
                )
                self.assertTrue(
                    warning_found,
                    "Expected overwrite warning not found",
                )
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    ...
                    fallback_found = any(
                        "Falling back" in call
                        for call in calls
                    )
                    self.assertTrue(
                        fallback_found,
                        "Expected fallback message not found",
                    )
    ...
    def test_create_output_directory(self):
        ...
        with patch(
            ...
            with patch(
                ...
                self.assertTrue(
                    dir_created,
                    "Expected directory creation message not found",
                )
